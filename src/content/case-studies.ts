...
const avgRight = average(samples.map((sample) => sample.right));`,
  ...
  spontus: {
    ...
    heroMedia: {
      type: "image",
      src: "/assets/images/case-studies/spontus/profile-proof.jpg",
      alt: "Spontus team profile showing roster, audience, sponsor, and hosted-race evidence",
      caption: "Seeded production demo showing how a team profile turns sponsorship history and audience data into structured marketplace evidence.",
    },
    details: [
    ...
    mediaGallery: [
      {
        type: "image",
        src: "/assets/images/case-studies/spontus/sponsorship-assets.jpg",
        alt: "Spontus team profile listing brand visibility, social content, product activation, and hosted-event sponsorship assets",
        caption: "Structured sponsorship inventory makes the team's available brand, content, and event activations directly inspectable.",
      },
      {
        type: "image",
        src: "/assets/images/case-studies/spontus/listing-access-gate.jpg",
        alt: "Spontus sign-in gate shown before marketplace listings and application actions",
        caption: "Listing access, applications, and sponsor posting begin behind an explicit account gate rather than an open anonymous flow.",
      },
      {
        type: "placeholder",
...
blt  t3, t5, DS_FAIL`,
  ...
  "operation-surf": {
    ...
    mediaGallery: [
      {
        type: "image",
        src: "/assets/images/case-studies/operation-surf/impact-results.jpg",
        alt: "Operation Surf website reporting decreases in PTSD symptoms and depression and an increase in self-efficacy",
        caption: "Live organization context: Operation Surf reports research outcomes of 36% lower PTSD symptoms, 47% lower depression, and 68% higher self-efficacy.",
        note: "Public organization outcome evidence; this is not a screenshot of the contributed Hack4Impact application.",
      },
      {
        type: "image",
        src: "/assets/images/case-studies/operation-surf/volunteer-hub.jpg",
        alt: "Operation Surf volunteer page with Join and Sign In controls for its public Volunteer Hub",
        caption: "The live volunteer page connects real staffing needs to a dedicated join and sign-in workflow.",
        note: "Current public volunteer workflow shown for operational context; it is separate from the contributed application.",
      },
      {
        type: "image",
        src: "/assets/images/case-studies/operation-surf/volunteer-programs.jpg",
        alt: "Operation Surf Volunteer Hub showing programs and upcoming event counts",
        caption: "The current public hub organizes volunteer opportunities by program and exposes upcoming-event availability.",
        note: "Current public volunteer workflow shown for operational context; it is separate from the contributed application.",
      },
      {
        type: "image",
